...
def read_args():
    ...
    # Runtype
    parser.add_argument('-runtype', type=str, default='normal', help='Runtype: normal, randomOversampling, randomUndersampling, SMOTE, SMOTETomek')
    return parser

def set_to_deterministic(seed):
    random.seed(seed)
    np.random.seed(seed)
...
if __name__ == '__main__':
    #set_to_deterministic(1) # remove the comment when Running Fixed NI-Factors
